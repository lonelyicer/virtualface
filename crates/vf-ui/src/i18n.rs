...
impl T {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::HomeEngine => "home.engine",
            Self::HomeRunning => "home.running",
            Self::HomeStopped => "home.stopped",
            Self::HomeTick => "home.tick",
            Self::HomeDrops => "home.drops",
            Self::HomeRate => "home.rate",
            Self::HomeStart => "home.start",
            Self::HomeStop => "home.stop",
            Self::HomeGraph => "home.graph",
            Self::HomeGraphName => "home.graph_name",
            Self::HomeGraphStats => "home.graph_stats",
            Self::HomePlugins => "home.plugins",
            Self::HomePluginsLoaded => "home.plugins_loaded",
            Self::HomeNodeStatus => "home.node_status",
            Self::HomeGraphEmpty => "home.graph_empty",
            ...
            Self::SettingsEngineRate => "settings.engine_rate",
            ...
            Self::GraphLoad => "graph.load",
            Self::GraphExport => "graph.export",
            Self::GraphLoadPrompt => "graph.load_prompt",
            ...
            Self::StatusTickRate => "status.tick_rate",
